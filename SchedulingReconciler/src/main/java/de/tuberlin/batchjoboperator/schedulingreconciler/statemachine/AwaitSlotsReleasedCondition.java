...
public class AwaitSlotsReleasedCondition extends SchedulingCondition {

    public static final String condition = AWAIT_SLOTS_RELEASED_CONDITION;
    ...
    public String getCondition() {
        return AWAIT_SLOTS_RELEASED_CONDITION;
    }
