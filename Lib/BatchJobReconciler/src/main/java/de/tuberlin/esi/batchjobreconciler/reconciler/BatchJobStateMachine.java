...
import static de.tuberlin.esi.common.crd.batchjob.BatchJobState.CompletedState;
import static de.tuberlin.esi.common.crd.batchjob.BatchJobState.FailedState;
import static de.tuberlin.esi.common.crd.batchjob.BatchJobState.InQueueState;
import static de.tuberlin.esi.common.crd.batchjob.BatchJobState.PendingDeletion;
import static de.tuberlin.esi.common.crd.batchjob.BatchJobState.ReadyState;
import static de.tuberlin.esi.common.crd.batchjob.BatchJobState.RunningState;
import static de.tuberlin.esi.common.crd.batchjob.BatchJobState.ScheduledState;
    ...
    public static final StateMachine<BatchJobContext> STATE_MACHINE = StateMachine.of(
            ...
            State.<BatchJobContext>withName(ReadyState.name())
                 .condition(OnCondition.any(
                         ...
                         InQueueState.name(),
                         BatchJobCondition.AWAIT_ENQUEUE_REQUEST_CONDITION
                 )).build(),
            ...
            State.<BatchJobContext>withName(PendingDeletion.name())
                 .condition(OnCondition.all(
                         ...
                         ReadyState.name(),
                         BatchJobCondition.AWAIT_DELETION_CONDITION
                 )).build(),
            ...
            State.<BatchJobContext>anonymous()
                 .condition(OnCondition.any(
                         ...
                         BatchJobCondition.AWAIT_RELEASE_CONDITION
                 ))
                 /*
                  * InQueueState:
                 ...
                 .subState(State.<BatchJobContext>withName(InQueueState.name())
                                .condition(OnCondition.any(
                                        ...
                                        BatchJobCondition.AWAIT_CREATION_REQUEST_CONDITION
                                ))
                                .build())
                 .subState(
                         /*
                         ...
                         State.<BatchJobContext>anonymous()
                              ...
                              .subState(State.<BatchJobContext>anonymous()
                                             .condition(OnCondition.any(
                                                     ...
                                                     CompletedState.name(),
                                                     BatchJobCondition.AWAIT_COMPLETION_CONDITION
                                             ))
                                             /*
                                              * SubmittedState:
                                             ...
                                             .subState(
                                                     State.<BatchJobContext>withName(BatchJobState.SubmittedState.name())
                                                          .condition(OnCondition.any(
                                                                  ...
                                                                  ScheduledState.name(),
                                                                  BatchJobCondition.AWAIT_POD_SCHEDULED_CONDITION
                                                          ))
                                                          .build()
                                             )/*
                                              * ScheduledState:
                                             ...
                                             .subState(State.<BatchJobContext>withName(ScheduledState.name())
                                                            .condition(OnCondition.any(
                                                                    ...
                                                                    RunningState.name(),
                                                                    BatchJobCondition.AWAIT_RUNNING_CONDITION
                                                            ))
                                                            .build())
                                             /*
                                              * RunningState:
                              ...
                              .condition(OnCondition.all(
                                      ...
                                      FailedState.name(),
                                      BatchJobCondition.DEBUG_CONDITION
                              ))
                              .condition(OnCondition.any(
