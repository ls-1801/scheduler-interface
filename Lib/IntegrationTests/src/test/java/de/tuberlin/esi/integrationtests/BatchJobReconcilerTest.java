...
import static de.tuberlin.esi.batchjobreconciler.reconciler.conditions.BatchJobCondition.AWAIT_COMPLETION_CONDITION;
import static de.tuberlin.esi.batchjobreconciler.reconciler.conditions.BatchJobCondition.AWAIT_CREATION_REQUEST_CONDITION;
import static de.tuberlin.esi.batchjobreconciler.reconciler.conditions.BatchJobCondition.AWAIT_DELETION_CONDITION;
import static de.tuberlin.esi.batchjobreconciler.reconciler.conditions.BatchJobCondition.AWAIT_ENQUEUE_REQUEST_CONDITION;
import static de.tuberlin.esi.batchjobreconciler.reconciler.conditions.BatchJobCondition.AWAIT_POD_SCHEDULED_CONDITION;
import static de.tuberlin.esi.batchjobreconciler.reconciler.conditions.BatchJobCondition.AWAIT_RELEASE_CONDITION;
import static de.tuberlin.esi.batchjobreconciler.reconciler.conditions.BatchJobCondition.AWAIT_RUNNING_CONDITION;
