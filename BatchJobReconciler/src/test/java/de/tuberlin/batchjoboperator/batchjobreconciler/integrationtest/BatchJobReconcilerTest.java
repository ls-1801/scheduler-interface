package de.tuberlin.batchjoboperator.batchjobreconciler.integrationtest;
...
import de.tuberlin.batchjoboperator.common.integrationtest.BaseReconcilerTest;
...
class BatchJobReconcilerTest extends BaseReconcilerTest {
    ...
    static {
        MAPPER.registerModule(BatchJobConditionDeserializer.getModule());
